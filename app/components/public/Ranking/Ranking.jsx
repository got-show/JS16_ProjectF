...
export default class Ranking extends Component {
  ...
  _onChange() {
    this.setState({twitterTopSentiments: SentimentStore.getTopSentiments(), twitterFlopSentiments: SentimentStore.getFlopSentiments(), twitterMostDiscussedSentiments: SentimentStore.getMostDiscussedSentiments(), twitterTopControversial: SentimentStore.getFlopSentiments()});
  }
  ...
  render() {
    ...
    return (<div>
      ...
      <Grid className="ranking tweets-fields">
          ...
          <Col sm={12} md={6}>
            <div className="ranking-field">
              <h2 className="text-center ranking-title twitterTooltip">Most Positive Mentions
                <OverlayTrigger placement="top" overlay={<Tooltip> love,
                  joy,
                  enthusiasm</Tooltip>}>
                ...
                this.state.twitterTopSentiments.map((char) => {
                  return <Row>
                    ...
                    <Col xs={4} className="text-center">
                      <OverlayTrigger trigger="hover" placement="top" overlay={<Tooltip><u><strong> Tweets</strong></u><br/><strong> {
                          char.positive
                        }
                        </strong>positive<br/><strong> {
                          char.negative
                        }
                        </strong>negative<br/> < strong > {
                          char.total
                        }
                        </strong>total</Tooltip>}>
          ...
          <Col sm={12} md={6}>
            <div className="ranking-field">
              <h2 className="text-center ranking-title twitterTooltip">Most Negative Mentions
                <OverlayTrigger placement="top" overlay={<Tooltip> hate,
                  fear,
                  anger,
                  frustration</Tooltip>}>
                  <Glyphicon glyph="question-sign"/>
        ...
        <Row className="ranking-fields">
          <Col sm={12} md={6}>
            <HousesTop5 className="ranking-field"/>
          </Col>
          <Col sm={12} md={6}>
            <Survivors className="ranking-field"></Survivors>
          </Col>
        </Row>
      </Grid>
    </div>);
